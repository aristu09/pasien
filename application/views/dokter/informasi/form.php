...
<div class="table-responsive">
    ...
    <script>
     ...
     $(document).on('submit', '#edit', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('dokter/informasi/api_edit/') ?>" + form_data.get('id_informasi'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    $(document).on('submit', '#editfile', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('dokter/informasi/api_upload/') ?>" + form_data.get('id_informasi'),
            dataType: "json",
            data: form_data,
            processData: false,
            contentType: false,
    ...
    function hapusfoto(id_informasi) {
        swal({
            ...
            if (result.value) { // Only delete the data if the user clicked on the confirm button
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('dokter/informasi/api_hapus/') ?>" + id_informasi,
                    dataType: "json",
                }).done(function() {
                    swal({
                        title: "Berhasil",
